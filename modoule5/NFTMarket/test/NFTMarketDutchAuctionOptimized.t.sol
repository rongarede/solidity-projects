...
import "../src/NFTMarketDutchAuctionOptimized.sol";
import "../src/MyCollectible.sol";

/**
 * @title NFT荷兰拍卖合约测试 (优化后版本)
 * @dev 测试NFTMarketDutchAuctionOptimized合约的所有功能
 */
contract NFTMarketDutchAuctionOptimizedTest is Test {
    NFTMarketDutchAuctionOptimized public auction;
    ...
    event AuctionCreated(
        ...
        NFTMarketDutchAuctionOptimized.AuctionData data
    );
    ...
    function setUp() public {
        // 部署合约
        auction = new NFTMarketDutchAuctionOptimized();
    ...
    function testCreateAuction() public {
        ...
        // 期望发出事件
        NFTMarketDutchAuctionOptimized.AuctionData memory auctionData = 
            NFTMarketDutchAuctionOptimized.AuctionData({
                tokenId: TOKEN_ID,
        ...
        emit AuctionCreated(0, seller, address(nft), auctionData);
        ...
        // 验证拍卖信息
        NFTMarketDutchAuctionOptimized.Auction memory auctionInfo = auction.getAuction(auctionId);
        ...
        assertEq(auctionInfo.status, 0); // ACTIVE
    }
    ...
    function testBuyNFT() public {
        ...
        // 验证拍卖状态
        NFTMarketDutchAuctionOptimized.Auction memory auctionInfo = auction.getAuction(auctionId);
        assertEq(auctionInfo.status, 1); // SOLD
    }
    ...
    function testCancelAuction() public {
        ...
        // 验证拍卖状态
        NFTMarketDutchAuctionOptimized.Auction memory auctionInfo = auction.getAuction(auctionId);
        assertEq(auctionInfo.status, 2); // CANCELLED
    }
    ...
    function testReentrancyProtection() public {
        ...
        ReentrancyAttackerOptimized attacker = new ReentrancyAttackerOptimized(auction);
...
// 用于测试重入攻击的恶意合约
contract ReentrancyAttackerOptimized is IERC721Receiver {
    NFTMarketDutchAuctionOptimized private auction;
    uint256 private auctionIdToAttack;
    
    constructor(NFTMarketDutchAuctionOptimized _auction) {
        auction = _auction;
    }
